 ...
 * @author manue
 */
public class JudgeEvaluationProgramacionFrameController implements Initializable {
    ...
    private CheckBox c7;
    @FXML
    private Label lblInsGen;
    @FXML
    private CheckBox c8;
    @FXML
    private Label lblSistAuto;
    @FXML
    private CheckBox c9;
    @FXML
    private CheckBox c10;
    @FXML
    private Label lblSistMan;
    @FXML
    ...
    @FXML
    private void frameEvaluationConstruccion(ActionEvent event) {
        Connection con = null;
        ...
        try {
            ...
            CallableStatement sp = con.prepareCall("{call createRowProgramacion(?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}");
            ...
            sp.setBoolean(18, c18.isSelected());
            sp.setBoolean(19, c19.isSelected());

            sp.executeUpdate();

            try {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/view/judgeEvaluationConstruccionFrame.fxml"));
                Parent root = loader.load();
                JudgeEvaluationConstruccionFrameController controller = loader.getController();
